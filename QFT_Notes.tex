...
\end{align}
Let $Q_S$ be the time-independent position operator in the Schr\"odinger representation that corresponds to the observable $q$. Let $q$ be the orthonormal eigenvalues of $Q_s$:
\begin{align}
Q_s\ket{q} &= q\ket{q}, \\
